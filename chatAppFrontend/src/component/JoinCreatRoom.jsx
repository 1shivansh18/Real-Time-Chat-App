...
const JoinCreatRoom = () => {
  ...
  async function createRoom() {
    if (valiDateForm()) {
      ...
      try {
        ...
        toast.success("Room Created Succussfully");
        setCurrUser(detail.userName);
  ...
  return (
    <div className="min-h-screen flex items-center justify-center border relative">
      ...
      <div className="p-8 w-full flex flex-col gap-5 max-w-md rounded dark:bg-gray-900 shadow">
        ...
        <div>
          <label htmlFor="roomId" className="font-medium block mb-2">
            Room Id / New room id
          </label>
          <input
            type="text"
        ...
        <div className="flex justify-center items-center gap-5 mt-4">
          <button
            onClick={joinRoom}
            className="px-3 py-2 dark:bg-blue-500 dark:hover:bg-blue-900 rounded-lg"
          >
            Join Room
          </button>
          ...
          <button
            onClick={createRoom}
            className="px-3 py-2 dark:bg-orange-500 dark:hover:bg-orange-900 rounded-lg"
          >
            Create Room
          </button>
        </div>
